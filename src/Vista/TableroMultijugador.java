...
import javax.swing.JPanel;
 /**
    *Constructor TableroMultijugador
    */
public class TableroMultijugador extends JFrame  {
    ...
    private EventosTableroMultijugador eventos=new EventosTableroMultijugador(this,camp);
    private int segundos=-1;
    public TableroMultijugador(){
        while(segundos<=0){
        try{ segundos=Integer.parseInt(JOptionPane.showInputDialog("Ingrese el tiempo en segundos por jugada"));
        c.setTiempo(segundos);
        }catch(NumberFormatException e){
            JOptionPane.showConfirmDialog(null,"Debe insertar un tiempo por jugada", "Error", JOptionPane.DEFAULT_OPTION);
        }
